...
export function createBottomDock({summary,event,evidence,trees,sources,processedAssets,store}){
  function render(state){
    ...
    summary.innerHTML=`<span class="ok">TREE</span> ${countTreeNodes(tree)} nodes &nbsp; | &nbsp; <span class="ok">SOURCES</span> ${sources.length} &nbsp; | &nbsp; <span class="ok">SELECTED</span> ${escapeHtml(selected.label)}`;
