const initial={
  ...
  treeFilter:'',inspectorOpen:false,selectedRecordId:null,selectedRecordNeedId:null,
  ...
  events:[{level:'ok',text:'Human TreeView now contains classifications only: sectors, categories, classes and bricks.'}],
  evidence:[{level:'ok',text:'19,009 product/service records remain linked to bricks and open in the Comparator datagrid; no item leaves remain in the tree.'}]
};
