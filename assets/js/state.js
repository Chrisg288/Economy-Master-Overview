const initial={
  ...
  events:[{level:'ok',text:'10,000 linked product records loaded into the modular Human tree and Comparator datagrid.'}],
  evidence:[{level:'ok',text:'Tree selection filters the datagrid; datagrid row selection returns to the exact product tree node.'}]
};
